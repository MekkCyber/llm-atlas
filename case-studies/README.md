...
- [Qwen2.5](qwen2-5.md) — Alibaba's 0.5B–72B dense family + proprietary MoE (Turbo, Plus). Standard architecture scaled through data (18T tokens) and a three-stage post-training pipeline (SFT → DPO → GRPO). Pair with DeepSeek-V3 for the "data scaling" vs "systems innovation" contrast.
